...
public class GameWorld {
    ...
    public void init(){
        ...
        helicopter = new Helicopter(worldSize, helipad.getLZ());
        ...
        for (GameObject go : gameObjects) {
            if (go instanceof Building) {
                ...
                for (int i = 0; i < NUMFIRE_BUILDING; i++) {
                    ...
                    building.setFireInBuilding(newFire);
    ...
    public void helicopterDrink() {
        ...
        while(iterator.hasNext()){
            ...
            GameObject tempGameObjects = (GameObject) iterator.next();
            if(tempGameObjects instanceof River){
                River tempRiver = (River) tempGameObjects;
                helicopter.drinkFrom(tempRiver);
            }
        }
    }
    ...
    public void tick() {
        ...
        while(iterator.hasNext()){
            ...
            if(tempGameObjects instanceof Building){
                ...
                building.setBuildingDamage(buildingDamage);
            }
            ...
            if(tempGameObjects instanceof MovableGameObject){
                ...
                if(tempGameObjects instanceof Helicopter) {
                    ...
                    if(helicopter.hasLandedAt(helipad) && areFiresOut){
                        restartOrQuit(Dialog.show("Game Over!",
