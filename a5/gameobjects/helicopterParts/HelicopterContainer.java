...
public class HelicopterContainer extends Container {
    ...
    public HelicopterContainer(int color) {
    ...
    public void updateLocalTransforms(double speed) {
