...
import org.csc133.a5.interfaces.*;
import org.csc133.a5.states.FireBurningState;
import org.csc133.a5.states.FireExtinguishedState;
import org.csc133.a5.states.FireUnstartedState;

import java.util.concurrent.CopyOnWriteArrayList;


public class Fire extends FixedGameObject implements IsDrawable, IsObservable, IsSelectable {
    ...
    private CopyOnWriteArrayList< IsObserver > myObservers;;
    private boolean selected;

    public Fire(Dimension worldSize, int fireSize) {

        myObservers = new CopyOnWriteArrayList < > ();
    ...
    public boolean contains(Point mousePoint) {
        ...
        double ptrX = mousePoint.getX();
        double ptrY = mousePoint.getY();
        ...
        Rectangle r1 = new Rectangle((int) ptrX, (int) ptrY, 3,3);
        Rectangle r2 = new Rectangle((int) fireX, (int) fireY, (int)(fireWidth), (int)(fireHeight));
    ...
    @Override
    public void addObserver(IsObserver obj) {
    ...
    public void notifyObservers() {
        ...
        if(!myObservers.isEmpty()){
            for(int i = 0; i < myObservers.size(); i++)
                ((IsObserver)myObservers.get(i)).update(this);
        }
    }
}