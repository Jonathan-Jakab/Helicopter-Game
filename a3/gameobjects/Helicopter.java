...
import org.csc133.a3.gameobjects.helicopterParts.HelicopterContainer;
import org.csc133.a3.interfaces.HelicopterState;
import org.csc133.a3.interfaces.IsSteerable;
import org.csc133.a3.states.*;
...
public class Helicopter extends MovableGameObject implements IsSteerable {
    ...
    private HelicopterContainer myHelicopter = new HelicopterContainer();
    ...
    public Helicopter(Dimension worldSize, Helipad helipad) { //Point2D lz) {
    ...
    public void isEngineStarting() {
        ...
        if (this.getHelicopterState().toString() == "starting") {
            ...
            myHelicopter.updateLTs(rotorSpeed);
            rotorSpeed += 1;
