...
import org.csc133.a4.interfaces.IsDrawable;
...
public class Building extends FixedGameObject implements IsDrawable {
    ...
    public int getNumBurningFires(CopyOnWriteArrayList<GameObject> gameObjects) {

        int numFires = 0;
        for (GameObject go: gameObjects) {
            if (go instanceof Fire) {

                Fire tempFire = (Fire) go;
                if (isFireInBuilding(tempFire)) {
